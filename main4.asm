...
__start:
    ...
    # Leer los coeficientes del polinomio (flotantes)
...
read_coeffs:
    ...
    li $v0, 6              # Syscall para leer un valor flotante (coeficiente)
    syscall
    swc1 $f0, 0($s0)       # Guardar el coeficiente en la memoria
...
read_x:
    ...
    # Evaluar el polinomio con coeficientes en punto flotante
...
eval_poly:
    ...
    lwc1 $f4, 0($s0)       # Cargar el coeficiente en $f4 (flotante)
...
.data
    msg_coeff:  .asciiz "Ingrese coeficiente (flotante): "
